...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		//当前域为8082，跨域请求的8081中的/rest/itemCat/list的请求
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	//使用jsonp来实现跨域请求,category.getDataService回调方法作为参数传递过去，
    	//被请求的域中将该域下的category.getDataService最为参数返回，被调用的域中的category.getDataService是一个JS语句
