...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'paramData',width:402,formatter:formatItemParamData">规格(只显示分组名称)</th>
            <th data-options="field:'created',width:232,align:'center',formatter:TAOTAO.formatDateTime">创建日期</th>
            <th data-options="field:'updated',width:225,align:'center',formatter:TAOTAO.formatDateTime">更新日期</th>
        </tr>
    </thead>
</table>
