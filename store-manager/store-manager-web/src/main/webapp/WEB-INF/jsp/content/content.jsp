        ...
        <div data-options="region:'center'" style="padding:5px">
		    ...
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'title',width:73">内容标题</th>
		            <th data-options="field:'subTitle',width:91">内容子标题</th>
		            <th data-options="field:'titleDesc',width:126">内容描述</th>
		            <th data-options="field:'url',width:109,align:'center',formatter:TAOTAO.formatUrl">内容连接</th>
		            <th data-options="field:'pic',width:52,align:'center',formatter:TAOTAO.formatUrl">图片</th>
		            <th data-options="field:'pic2',width:50,align:'center',formatter:TAOTAO.formatUrl">图片2</th>
		            <th data-options="field:'created',width:161,align:'center',formatter:TAOTAO.formatDateTime">创建日期</th>
		            <th data-options="field:'updated',width:165,align:'center',formatter:TAOTAO.formatDateTime">更新日期</th>
		        </tr>
		    </thead>
		</table>
        </div>
